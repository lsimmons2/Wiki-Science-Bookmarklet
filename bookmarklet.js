...
if(numerator2 == 0){
	...
	header.id = 'header';
	header.innerHTML= 'Woops! Either there are no scientific journal articles used as references for this Wikipedia article, or this bookmarklet has failed its purpose.';
